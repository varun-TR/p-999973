...
const MerchStore = () => {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const response = await fetch("https://1331-2600-4040-4783-ee00-a8b2-73c8-8125-21be.ngrok-free.app/create-checkout-session", { // http://localhost:4242/create-checkout-session
        method: "POST",
        headers: {
